...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        `http://127.0.0.1:8000/api/register/${token}/`,
        form,
                  ...
                  {showPassword ? (
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a10.05 10.05 0 012.133-3.362m3.185-2.436A9.956 9.956 0 0112 5c4.478 0 8.268 2.943 9.542 7a9.977 9.977 0 01-4.52 5.309M15 12a3 3 0 00-3-3"
                      />
                      <line
                        x1="3"
                        y1="3"
